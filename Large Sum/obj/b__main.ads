...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#cc2bc50d#;
   ...
   u00139 : constant Version_32 := 16#67951f71#;
   pragma Export (C, u00139, "ada__numerics__big_numbers__big_integersB");
   u00140 : constant Version_32 := 16#6cd5c494#;
   pragma Export (C, u00140, "ada__numerics__big_numbers__big_integersS");
   u00141 : constant Version_32 := 16#989abe51#;
   pragma Export (C, u00141, "system__shared_bignumsS");
   u00142 : constant Version_32 := 16#c9a3fcbc#;
   pragma Export (C, u00142, "system__stream_attributesB");
   u00143 : constant Version_32 := 16#414158da#;
   pragma Export (C, u00143, "system__stream_attributesS");
   u00144 : constant Version_32 := 16#3e25f63c#;
   pragma Export (C, u00144, "system__stream_attributes__xdrB");
   u00145 : constant Version_32 := 16#ce9a2a0c#;
   ...
   u00147 : constant Version_32 := 16#cafa8775#;
   ...
   --  system.val_lllu%s
   --  system.val_llli%s
   --  ada.numerics.big_numbers.big_integers%s
   --  ada.numerics.big_numbers.big_integers%b
   --  system.val_uns%s
   --  system.val_int%s
   --  ada.text_io%s
   --  ada.text_io%b
